...
/**
 * Slugify a translated label to a URL-friendly slug.
 */
...
/**
 * Build a translated path for a known navigation key (e.g. 'home', 'about').
 */
export function translatedPathFor(
  t: any,
  lang: Locale,
  key: string
): string {
