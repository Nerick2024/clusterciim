...
Desde el **ClusterCIIM**, apostamos por un **modelo abierto e interoperable**, donde **los datos, los diseños y los procesos se compartan** para generar **innovación colectiva**. Creemos que la creación de un **ecosistema digital común** es la clave para escalar el modelo industrializado y hacerlo llegar a todo el territorio.
